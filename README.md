# Tour de App - Vanilla JS + Express Boilerplate

> **Note:** Czech version is available below / Česká verze je k dispozici níže

A template for developing applications for the Tour de App competition with a frontend in Vanilla JavaScript and a backend in [Express](https://expressjs.com/).
...
Šablona pro vývoj aplikace v soutěži Tour de App společně s frontendovou částí ve Vanilla JavaScript a backendovou částí v [Express](https://expressjs.com/).
